<!-- Spark_Vault_uniapp/src/pages/dashboard/index.vue -->
<template>
  <scroll-view scroll-y class="iv-page dashboard">
    ...
    <view class="tool-row">
      ...
      <button class="iv-outline-button tool-button" @click="switchTab('/pages/workspace/index')">◎ AI Research Workspace</button>
    </view>
    ...
    <view class="iv-soft-card insight">
      ...
      <view class="insight-actions">
        ...
        <button class="insight-secondary" @click="switchTab('/pages/workspace/index')">View Map</button>
      </view>
    </view>
  </scroll-view>
</template>
